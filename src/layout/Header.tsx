                    ...
                    <div className="container">
                        <div className="dz-topbar-inner d-flex justify-content-between align-items-center">
                            <div className="dz-topbar-left">
                                <ul>
                                    <li><Link href="tel:+22901470474"><i className="feather icon-phone-call text-primary" /> +229 01 47 04 74 43</Link></li>
                                    <li><Link href="mailto:contact@akademlife.com"><i className="feather icon-mail text-primary" /> contact@akademlife.com</Link></li>
                                </ul>
                            </div>
