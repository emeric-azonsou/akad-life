            ...
            <div className="row align-items-center">
                <div className="col-xl-6 order-xl-1 m-b30">
                    <div className="section-head style-3">
                        <h2 className="title wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">Notre Équipe de Spécialistes</h2>
                        <p className="m-b0 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">Des gynécologues, sages-femmes et professionnels de santé dévoués à votre bien-être et à celui de votre enfant.</p>
                    </div>
                    <Swiper
                                    ...
                                    <div className={`dz-team style-3 ${hover === data.id ? 'active' : ''}`} onMouseEnter={() => setHover(data.id)}>
                                        <div className="dz-body">
                                            <div className="dz-media">
                                                <Image src={CUSTOM_IMAGES.doctorPortrait1} alt="Docteur spécialiste" />
                                            </div>
                                            <div className="dz-content">
                                                <h3 className="dz-name"><Link href={"#"} scroll={false}>{data.name}</Link></h3>
                                                <span className="dz-position">Gynécologie-Obstétrique</span>
                                            </div>
                                        </div>
                            ...
                            return (
                                <SwiperSlide key={i}>
                                    <div className="dz-team style-4">
                                        <div className="dz-media">
                                            <Image src={CUSTOM_IMAGES.gynecologyService} alt="Service gynécologique" />
                                        </div>
                                        <ul className="dz-social">
                                            ...
                                            <div className="info-widget style-3">
                                                <div className="widget-head">
                                                    <div className="widget-media">
                                                        <Image src={CUSTOM_IMAGES.doctorPortrait1} alt="Dr. Marie N. D'ALMEIDA" />
                                                    </div>
                                                    <div className="widget-content">
                                                        <h6 className="title">Dr. Marie N. D'ALMEIDA</h6>
                                                        <span className="sub-title text-primary">Gynécologue-Obstétricienne</span>
                                                    </div>
                                                </div>
                                                <p>“Chaque femme mérite un accompagnement de qualité pour sa santé et sa maternité”</p>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
