      ...
      <div className="container">
        <div className="section-head style-3 row align-items-end justify-content-between m-b30">
          <div className="col-xl-5 col-lg-6 m-b10 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
            <h2 className="title m-b0">Ce que nos patientes disent de nous</h2>
          </div>
          <div className="col-xl-6 col-lg-6 m-b10 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
            <div className="float-xl-end">
              <div className="d-flex align-items-center m-b15">
                <div className="info-widget style-12 m-r10 bg-light">
                  ...
                  <div className="clearfix">
                    <span className="font-20">Échangez avec nos spécialistes</span>
                  </div>
                </div>
              ...
              <div className="widget-rating3 large">
                ...
                <span className="text text-body fw-normal">Avis vérifiés sur Google</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="testimonial-2">
                <div className="testimonial-media">
                  ...
                  <div className="video-bx1 video-lg">
                    ...
                    <span className="text-black">Voir la Vidéo</span>
                ...
                <div className="testimonial-detail">
                  <div className="testimonial-head">
                    ...
                    <h3 className="title">Soins Exceptionnels</h3>
                  </div>
                  <div className="testimonial-contant">
                    <div className="testimonial-text">
                      <p>
                        J'ai été accompagnée tout au long de ma grossesse par l'équipe d'AKAD'LIFE. Leur professionnalisme,
                        leur écoute et leur bienveillance m'ont permis de vivre ma maternité en toute sérénité.
                        Je recommande cette clinique à toutes les femmes.
                      </p>
                    </div>
                  </div>
                  <div className="testimonial-info">
                      ...
                      <div className="clearfix">
                        ...
                        <span className="testimonial-position">Patiente — Comè</span>
                      </div>
                  </div>
                </div>
              </div>
