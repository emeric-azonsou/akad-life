                    ...
                    <div className="form-wrapper style-1 m-l40">
                        <div className="form-body bg-secondary background-blend-burn" style={{ backgroundImage: `url(${IMAGES.bg2png.src})`, backgroundSize: 'cover', backgroundPosition: 'bottom right', }}>
                            <div className="section-head style-1 m-b30">
                                <h2 className="title text-white">Contactez <br /> Notre Clinique</h2>
                            </div>
                            <form onSubmit={(e) => e.preventDefault()} className="dzForm row">
                                ...
                                <div className="col-sm-6 m-b30">
                                    <div className="form-floating floating-underline input-light">
                                        <input name="dzEmail" type="email" className="form-control" id="inputYourEmail2" placeholder="Votre Email" />
                                        <label htmlFor="inputYourEmail2">Votre Email</label>
                                    </div>
                                </div>
                                <div className="col-sm-12 m-b30">
                                    <div className="form-floating floating-underline input-light">
                                        <textarea name="dzMessage" className="form-control" id="inputMessage" rows={6} placeholder="Votre message"></textarea>
                                        <label htmlFor="inputMessage">Message</label>
                                    </div>
                                </div>
                                <div className="col-sm-12">
                                    <button type="submit" name="submit" value="submit" className="btn btn-lg btn-icon btn-white btn-shadow">
                                        Prendre Rendez-vous <span className="right-icon"><i className="feather icon-arrow-right" /></span>
                                    </button>
                                </div>
                            </form>
                        </div>
