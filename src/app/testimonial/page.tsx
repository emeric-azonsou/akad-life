                ...
                <section className="content-inner-1">
                    <div className="container">
                                            ...
                                            <div className="testimonial-2">
                                                <div className={data.classChange}>
                                                    <div className="testimonial-head">
                                                        ...
                                                        <h3 className="title">Excellent Accompagnement</h3>
                                                    </div>
                                                    <div className="testimonial-contant">
                                                        <div className="testimonial-text">
                                                            <p>J'ai été suivie tout au long de ma grossesse à la Clinique AKAD'LIFE. L'équipe médicale est attentionnée, professionnelle et rassurante. Je recommande vivement cette clinique à toutes les femmes.</p>
                                                        </div>
                                                    </div>
                        ...
                        <div className="dz-separator style-3">
                            <Link href={"#"} scroll={false} className="btn separator-badge dz-load-more wow fadeInUp" data-wow-delay="1.4s" data-wow-duration="0.8s" rel="ajax/testimonial">Voir Plus</Link>
                        </div>
                    </div>
                </section>
                <CompareSwiper />
