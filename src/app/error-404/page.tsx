                        ...
                        <div className="row align-items-center justify-content-center">
                            ...
                            <div className="col-md-5 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
                                <div className="inner-content">
                                    <h2 className="dz-error">Oups !</h2>
                                    <p className="text">La page que vous recherchez est introuvable</p>
                                    <Link href="/" className="btn btn-primary btn-hover1">Retour à l’accueil</Link>
                                </div>
                            </div>
                        </div>
                    </div>
